...
anvil --load-state avs-and-eigenlayer-deployed-anvil-state.json --steps-tracing &
ANVIL_PID=$!
...
forge script script/IncredibleSquaringDeployer.s.sol --sig "run()" 100 --rpc-url $RPC_URL  --private-key $PRIVATE_KEY --broadcast
